...
public class GraphExpressionReverserLogicMulti {
    ...
    public GraphExpressionReverserLogicMulti(BitOpsGraphCalculator calculator) {
    ...
    public static SingleBitReverser reverser() {
        return (calculator, bitName, truth) -> {
            ...
            return (BooleanExpression) value -> {
                ...
                GraphExpressionReverserLogicMulti graphExpressionReverserLogic2 = graphExpressionReverserLogic;
    ...
    private void reverse(NamedBit varBit) {
        ...
        for (OperationalBit operationalBit : usage) {
            ...
            if (operationalBit.getOperation() == Operation.AND) {
                ...
                if(bits.length == 1) {
                    Bit theTruth = bits[0];
                    Bit theFalsy = innerCalculator.not(bits[0]);
                    if (truth == null) {
                        truth = (NamedBit) theTruth;
                        falsy = (NamedBit) theFalsy;
                    }
