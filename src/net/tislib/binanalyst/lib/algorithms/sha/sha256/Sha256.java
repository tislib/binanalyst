...
public class Sha256 {
     ...
     */
    public static int[] hash(byte[] message) {
        // let H = H0
...
//            System.out.println("copy TEMP:" + toHex(TEMP));
...
//                System.out.println("rotateRight/" + t + ":" + toHex(Integer.rotateRight(TEMP[4], 6)));
//                System.out.println("bigSig1/" + t + ":" + toHex(bigSig1(TEMP[4])));
//                System.out.println("t1/" + t + ":" + toHex(t1));
//                System.out.println("W/" + t + ":" + toHex(W[t]));
//                System.out.println("W/" + t + ":" + (W[t]));

                int t2 = bigSig0(TEMP[0]) + maj(TEMP[0], TEMP[1], TEMP[2]);
//                System.out.println("t2/" + t + ":" + toHex(t2));
//                System.out.println("tp/" + t + ":" + toHex(t1 + t2));
                System.arraycopy(TEMP, 0, TEMP, 1, TEMP.length - 1);
                TEMP[4] += t1;
                TEMP[0] = t1 + t2;

//                System.out.println("TEMP" + t + ":" + toHex(TEMP));
            }
