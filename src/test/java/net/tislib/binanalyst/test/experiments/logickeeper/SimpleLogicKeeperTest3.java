package net.tislib.binanalyst.test.experiments.logickeeper;
...
import net.tislib.binanalyst.lib.calc.logickeeper.OptimizedBitLogicKeeper;
import net.tislib.binanalyst.lib.operator.BinMul;
import org.junit.Test;

public class SimpleLogicKeeperTest3 {
...
//        calculator = new UnusedBitOptimizerDecorator(calculator);
        ...
        BitLogicalKeeper bitLogicalKeeper = new OptimizedBitLogicKeeper(calculator);
